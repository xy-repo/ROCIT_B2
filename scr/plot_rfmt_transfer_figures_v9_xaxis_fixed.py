...
Only the antibiotic strip shows RFMT column names; the upper panel x-axis labels are hidden.
...
def main():
    ...
    outdir = Path(args.outdir) if args.outdir else indir / "figures_v9_xaxis_fixed"
